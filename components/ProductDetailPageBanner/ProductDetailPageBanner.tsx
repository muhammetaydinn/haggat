...
export function ProductDetailPageBanner({
  productDetailData,
}: ProductDetailPageBannerProps) {
          ...
          <Group align="center">
            <div>
              <Rating
                ...
                //between 2 and 5
                defaultValue={
                  (productDetailData.id % 3) + 2 + Math.random() * 0.5
                }
              />
            </div>
            <Text fz="sm" c="dimmed">
              {productDetailData.id * productDetailData.price} reviews
            </Text>
          </Group>
